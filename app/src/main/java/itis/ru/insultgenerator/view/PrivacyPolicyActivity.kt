...
class PrivacyPolicyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tv_privacy_policy.text = Html.fromHtml("<h2>Privacy Policy</h2> <p>\n" +
                "                     built the Insult Generator app as\n" +
                ...
                "                    Insult Generator unless otherwise defined in this Privacy\n" +
                "                    Policy.\n" +
                "                  </p> <p><strong>Information Collection and Use</strong></p> <p>\n" +
                "                    For a better experience, while using our Service,\n" +
                "                    I may require you to provide us with certain\n" +
                "                    personally identifiable information, including but not limited to location. The\n" +
